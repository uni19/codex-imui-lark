...
describe("release check", () => {
  ...
  test("flags machine-specific absolute paths in README", async () => {
    const root = await mkdtemp(path.join(tmpdir(), "codex-feishu-release-"))
    ...
    try {
      ...
      await writeFile(
        ...
        [
          ...
          "[docs/10-release-checklist.md](/Users/bytedance/workspace/codex-feishu-imui/docs/10-release-checklist.md)",
          "",
          "## 当前支持的 IM 命令",
          "- `/help`: 查看帮助",
          "- `/status`: 查看当前会话状态",
