...
describe("release package", () => {
  ...
  test("renders package readme and archive name", () => {
    expect(archiveBase("0.1.0", "bun-darwin-arm64")).toBe("codex-feishu-imui-0.1.0-bun-darwin-arm64")
    ...
    expect(readme).toContain("codex-feishu-imui")
    expect(readme).toContain("larksuite/cli")
    expect(readme).toContain("npx @larksuite/cli@latest install")
    expect(readme).toContain("codex app-server --stdio")
    expect(readme).not.toContain("codex serve --hostname 127.0.0.1 --port 4096")
    expect(readme).toContain("codex-feishu-imui-service install")
    expect(readme).toContain("CODEX_DIRECTORY=/absolute/path/to/your/working-directory")
    expect(readme).toContain("CODEX_WORKSPACE=")
    expect(readme).not.toContain("CODEX_DIRECTORY=/absolute/path/to/your/worktree")
