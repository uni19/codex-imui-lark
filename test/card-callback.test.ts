...
import type { FeishuApi, ImSession, InboundCardAction, InboundMessage, CodexResult, CodexStatus, CodexSvc, RenderOut, Task } from "../src/contracts.ts"
...
function codex(input?: { status?: Record<string, CodexStatus> | null; last?: string | undefined; result?: CodexResult }) {
  const svc = {
    ...
    async status(_payload: { directory?: string; workspace?: string }): Promise<Record<string, CodexStatus>> {
